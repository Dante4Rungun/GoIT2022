...
function createGallery() {
    const items = [];
    for (const element of (0, _galleryItems.galleryItems)){
...
gallery.addEventListener("click", (event)=>{
    ...
    let gallery1 = new (0, _simplelightboxDefault.default)(".gallery a", {});
    gallery1.options.captionsData = "alt";
    gallery1.options.captionDelay = "250ms";
});
...
},{}],"kaxSc":[function() {},{}]},["b4hXe","6XVkV"], "6XVkV", "parcelRequired7c6")
